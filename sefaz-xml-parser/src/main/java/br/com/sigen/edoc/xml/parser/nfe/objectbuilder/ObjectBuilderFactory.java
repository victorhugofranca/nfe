...
import br.com.sigen.edoc.xml.parser.nfe.objectbuilder.nfe.infNFe.InfNFeBuilder;
...
import br.com.sigen.edoc.xml.parser.nfe.objectbuilder.nfe.infNFe.det.prod.di.adi.AdiBuilder;
...
import br.com.sigen.edoc.xml.parser.nfe.objectbuilder.nfe.signature.SignatureBuilder;
...
public class ObjectBuilderFactory extends ObjectBuilderAbstractFactory {
	...
	public ICMSBuilder createInfNfeDetImpostoIcmsBuilder() {
		...
		icmsBuilder.setIcms60Builder(createInfNfeDetImpostoIcmsIcms60Builder());
	...
	@Override
	public Icms60Builder createInfNfeDetImpostoIcmsIcms60Builder() {
		return new Icms60Builder();
	}
